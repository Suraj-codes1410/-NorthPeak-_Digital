...
export const workProjects: Project[] = [
  {
    ...
    outcome: 'Reconstructed patient consulting portal resulting in a 42% reduction in booking drop-offs and a 95% accessibility score.',
  },
  {
    name: 'Vektor Capital',
    ...
    outcome: 'Engineered an ultra-fast asset tracking interface, driving a 28% increase in daily active dashboard users.',
  },
  {
    name: 'Lumen Academy',
